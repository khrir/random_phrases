function renderForm(){
    let form = $('<form id="form" method="post" action="/submitForm">')
    ...
    let div2 = $('<div class="input"><input id="frase" name="frase" type="text" required maxlength="100"><label>Frase</label></div>')
